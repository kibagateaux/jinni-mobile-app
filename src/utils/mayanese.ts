...
import { format, formatDistance, addDays, subDays, formatISO, } from 'date-fns/fp';
import { flow, now, map, entries, range, fromPairs } from 'lodash/fp';
...
const portalDayConfig: Kin = [
    138,
    tones[7],
    archetypes[17],
];

// TODO run for next 3 years and export to JSON
    ...
    const generateTzolkinCalConfig =  (i) => {
        ...
        return [
            formattedDate,
            {
                ...
                periods: [ // TODO wavespell calculations
                    {
